...
{	
	NSString *countString = [NSString stringWithFormat:@"%d", self.badgeNumber];
...
- (void) layoutSubviews
{
	...
	if(self.badgeNumber != 0)
	{
		...
		NSString *badgeString = [NSString stringWithFormat: @"%d", self.badgeNumber];
		if(badgeNumber == -1)
			badgeString = @"new";

		CGSize badgeSize = [badgeString sizeWithFont:[UIFont boldSystemFontOfSize: 14]];
